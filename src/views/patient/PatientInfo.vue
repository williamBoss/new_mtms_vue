        ...
        <a-tabs default-active-key="1">
          <a-tab-pane key="1" tab="患者信息">
            ...
            >
              <a-form-model-item ref="phone" prop="phone">
                ...
                >
                  <template slot="dataSource">
                    <a-select-option v-for="p in patientInfo" :key="p.phone" :title="p.phone">
                      {{ p.phone }}-{{ p.patientName }}
                    </a-select-option>
                  </template>
                </a-auto-complete>
              </a-form-model-item>
              <a-form-model-item label="患者姓名" ref="patientName" prop="patientName">
                <a-input v-model="form.patientName" placeholder="请输入" />
              </a-form-model-item>
              <a-form-model-item label="年龄" ref="age" prop="age">
                <a-input-number v-model="form.age" placeholder="请输入" style="width: 100%;" />
              </a-form-model-item>
              ...
              <a-form-model-item label="患者ID" ref="patientSelfId" prop="patientSelfId">
                <a-input v-model="form.patientSelfId" placeholder="请输入" />
              </a-form-model-item>
              <a-form-model-item label="身高(CM)" ref="height" prop="height">
                <a-input-number
                  v-model="form.height"
                  :min="0"
                  :max="1000"
              ...
              <a-form-model-item label="体重(KG)" ref="weight" prop="weight">
                <a-input-number
                  v-model="form.weight"
                  :min="0"
                  :max="1000"
              ...
              <a-form-model-item ref="bmi" prop="BMI">
                <span slot="label">
                  bmi&nbsp;
              ...
              <a-form-model-item label="身份证号" ref="idCardNum" prop="idCardNum">
                <a-input v-model="form.idCardNum" placeholder="请输入" />
              </a-form-model-item>
              <a-form-model-item label="医保类型" ref="medicareType" prop="medicareType">
                <a-radio-group v-model="form.medicareType" button-style="solid">
                  <a-radio-button :value="1">
                    自费
                  </a-radio-button>
                  <a-radio-button :value="2">
              ...
              <a-form-model-item ref="otherMedicareType" prop="otherMedicareType">
                <span slot="label">
                  其他医保类型&nbsp;
                ...
                <a-input v-model="form.otherMedicareType" placeholder="请输入" />
              </a-form-model-item>
              <a-form-model-item label="受教育程度" ref="educationLevel" prop="educationLevel">
                <a-radio-group v-model="form.educationLevel" button-style="solid">
                  <a-radio-button :value="1">
                    小学及以下
                  </a-radio-button>
                  <a-radio-button :value="2">
              ...
              <a-form-model-item label="婚姻状况" ref="maritalStatus" prop="maritalStatus">
                <a-radio-group v-model="form.maritalStatus" button-style="solid">
                  <a-radio-button :value="1">
                    已婚
                  </a-radio-button>
                  <a-radio-button :value="2">
              ...
              <a-form-model-item label="家庭住址" ref="downtownAddressArr" prop="downtownAddressArr">
                <span>所在地区</span>
                <a-cascader
                ...
                />
                <span>详细地址</span>
                <a-input v-model="form.homeAddress" placeholder="请输入详细家庭住址" style="margin:5px 0 10px 0;" />
              </a-form-model-item>
              <a-form-model-item label="工作单位" ref="company" prop="company">
                <a-input v-model="form.company" placeholder="请输入" />
              </a-form-model-item>
              <a-form-model-item label="就诊后一年" ref="emergencyInfusionNum" prop="emergencyInfusionNum">
                <span>急诊/输液次数</span>
                <a-input v-model="form.emergencyInfusionNum" placeholder="请输入" style="margin:5px 0 10px 0;" />
                <span>住院次数</span>
                <a-input v-model="form.hospitalizationNum" placeholder="请输入" style="margin:5px 0 10px 0;" />
              </a-form-model-item>
              <a-form-model-item>
          ...
          <a-tab-pane key="2" tab="评估记录" force-render>
            ...
            <a-timeline v-else>
              <a-timeline-item v-for="(r, index) in assessmentRecording" :key="index">
                {{ r.fillDate }}
          ...
          <a-tab-pane key="3" tab="药物不良反应记录" force-render>
            <a-timeline>
              <a-timeline-item>
                2017-09-01
                <a-tag color="#2db7f5" style="float: right;">
