<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="48">
          ...
          <a-col :md="8" :sm="24">
            <a-form-item label="患者联系方式">
              <a-input v-model="queryParam.phone" placeholder="请输入患者手机号" />
            </a-form-item>
          </a-col>
          <a-col :md="8" :sm="24">
            <a-form-item label="患者身份证号">
              <a-input v-model="queryParam.idCardNum" placeholder="请输入患者手机号" />
            </a-form-item>
          </a-col>
          <template v-if="advanced">
            <a-col :md="8" :sm="24">
              <a-form-item label="评估时间">
                <a-range-picker v-model="searchDate" @change="queryFillDate" allow-clear="true" />
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
              <a-form-item label="诊断病种">
                <a-select
                  ...
                  allowClear="true"
                >
                  <a-select-option v-for="d in diseases" :key="d.diseaseId">
                    {{ d.diseaseName }}
                  </a-select-option>
                </a-select>
              </a-form-item>
          ...
          <a-col :md="8" :sm="24">
            <span
              ...
              <a-button style="margin-left: 8px" @click="clearSearchContent">重置</a-button>
    ...
    <div class="table-operator">
      <a-button type="primary" icon="plus" @click="linkPatientAssessment">新建</a-button>
    </div>
    <s-table
      size="default"
      ref="table"
    ...
    >
      ...
      <template slot="diseases" slot-scope="disease">
        <a-tag v-for="d in disease" :key="d" color="blue">{{ d.diseaseName }}</a-tag>
      </template>
